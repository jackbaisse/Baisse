...
using Baisse.CommonLibrary.Extension.RPCModel;
...
namespace ConsoleAppClient
{
    public class Request<T>
    {
        ...
        static Action<RpcServerContext, ResponseContent<T>> _action;
        ...
        //        //发送消息
        //        smanager.Send(outputBuffer);

        //        int length = smanager.Receive(buffer);  // length 接收字节数组长度
