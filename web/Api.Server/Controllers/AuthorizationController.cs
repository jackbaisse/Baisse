...
namespace HDF.Blog.WebApi.Controllers
{
    ...
    public class AuthorizationController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ApiResponse<string>> UserLogin([FromForm] string userCode, [FromForm] string password)
        {
            if (userCode != "admin")
                return ApiResponse.Fail<string>("该用户不存在！");
        ...
        [HttpPost]
        public ApiResponse<string> Test(ApiRequest input)
        {
